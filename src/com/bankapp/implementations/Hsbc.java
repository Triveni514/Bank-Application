...
public class Hsbc implements Bank {
	...
	public List<String> dataRead() throws NumberFormatException, IOException {
		...
		System.out
				.println("How many HSBC Bank employee details you are going to enter");
	...
	public void getData() throws NumberFormatException, IOException {
		...
		for (int i = 0; i < l.size(); i = i + 3) {
			System.out.println("HSBC Bank Employee " + (c + 1) + " details");
			for (int j = i; j < i + 3; j++) {
	...
	public int rateOfInterest() throws NumberFormatException, IOException {
		int roi;
		System.out.println("Please Enter Rate Of Interest for HSBC Bank");
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
	...
	public void getRateOfInterest() throws NumberFormatException, IOException {
		...
		System.out.println("Rate of Interest for HSBC Bank is:" + roi);
	}
